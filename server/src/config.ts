...
export class Config {
    ...
    'application.swagger.default-include-pattern' = '/api/.*';
    'application.swagger.title' = 'skygge_validate API';
    'application.swagger.description' = 'skygge_validate API documentation';
    'application.swagger.version' = '0.0.1';
    'application.swagger.path' = '/api/v2/api-docs';
    ...
    'eureka.instance.appname' = 'skygge_validate';
    'eureka.instance.instanceId' = 'skygge_validate:${random.value}';
    ...
    'eureka.client.service-url.defaultZone' = 'http://admin:${application.registry.password}@localhost:8761/eureka/';
    'cloud.config.uri' = 'http://admin:${application.registry.password}@localhost:8761/config';
    'cloud.config.name' = 'skygge_validate';
