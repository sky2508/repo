...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'skygge_validate';
    ...
    'jhipster.mail.from' = 'skygge_validate@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'skygge_validate API';
    'jhipster.swagger.description' = 'skygge_validate API documentation';
